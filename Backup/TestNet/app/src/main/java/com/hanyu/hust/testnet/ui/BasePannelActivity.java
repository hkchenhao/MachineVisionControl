...
import com.hanyu.hust.testnet.ui.view.DialogBuilder;
 ...
 * @author MC
 */
public abstract class BasePannelActivity extends Activity
{
	/**
	...
	protected void sendJson(String id, JsonObject json)
	{
		CmdHandle cmdHandle = CmdHandle.getInstance();
		cmdHandle.setJson(id, json.toString().getBytes());
	}
		...
		listview.setOnItemClickListener(new OnItemClickListener()
		{
                                    ...
                                    int position, long id)
			{
						...
						&& !wholeMenu.subMenu[position].equals(""))
				{
					...
					DialogBuilder builder = new DialogBuilder(BasePannelActivity.this, position);
