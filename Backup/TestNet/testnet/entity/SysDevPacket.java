...
public class SysDevPacket {
    ...
    public static class Trigger {
        ...
        public int trigDelay;   // 触发距离 0.1mm
        public int partDelay;   // 分拣触发距离 0.1mm
        public int velocity;    // 传送带速度 mm/s
        public int departWide;  // 分拣信号宽度 ms
        public int expLead;     // 预设曝光时间 us
        public int checksum;
    }
